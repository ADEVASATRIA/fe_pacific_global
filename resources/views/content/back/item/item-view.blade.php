...
@section('page-script')
    @vite([
        'resources/js/service/back/item/item_view.js',
        'resources/js/service/back/item/item_category/item_category_view.js'
    ])
@endsection
...
@section('content')
                ...
                <ul class="nav nav-tabs nav-fill" role="tablist">
                    <li class="nav-item">
                        <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab"
                            data-bs-target="#tab-items" aria-controls="tab-items"
                    ...
                    <li class="nav-item">
                        <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                            ...
                            aria-selected="false"><span class="d-none d-sm-block"><i
                                    class="tf-icons bx bx-category bx-sm me-1_5 align-text-bottom"></i> Item Categories</span><i
                                class="bx bx-category bx-sm d-sm-none"></i></button>
                    </li>
                </ul>
                    ...
                    <div class="tab-pane fade" id="tab-item-categories" role="tabpanel">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <button type="button" class="btn btn-primary" id="addCategoryBtn" data-bs-target="#itemCategoryModal" data-bs-toggle="modal">
            ...
            <form id="itemCategoryForm" class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-12 mb-3">
                            ...
                            <input type="text" id="nameCategory" class="form-control" placeholder="Enter Item Category Name" required>
                        </div>
                        <div class="col-12 mb-3">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" id="saveItemCategoryBtn">
                        ...
                        <span id="saveItemCategoryBtnSpinner" class="spinner-border spinner-border-sm d-none" role="status" aria-hidden="true"></span>
                    </button>
                </div>
            </form>
        </div>
    ...
    <div class="bs-toast toast fade bg-success" role="alert" aria-live="assertive" aria-atomic="true" id="toastNotification">
